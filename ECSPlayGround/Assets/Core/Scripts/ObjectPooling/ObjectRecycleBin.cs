...
{
    [System.Serializable]
    public sealed class ObjectRecycleBin
    {
        /// <summary>
        ...
        /// <summary>
        /// if true and ObjectPool.persistBetweenScenes is true this recycle bin will not be purged when a new level loads
        /// </summary>
            ...
            if( go != null )
            {
                ...
                if( automaticallyRecycleParticleSystems )
                {
                    ...
                    if( system )
                    {
                        ...
                        ObjectPool.despawnAfterDelay( go, system.duration + system.startLifetime );
                    }
                    else
                    {
