...
namespace UnityCode.Core.Scripts.ObjectPooling
{
    public class ObjectPool : MonoBehaviour
    {
        ...
        /// </summary>
        [HideInInspector]
        public List<ObjectRecycleBin> recycleBinCollection;

        /// <summary>
        /// this is how often in seconds ObjectPool should cull excess objects. Setting this to 0 or a negative number will
        /// fully turn off automatic culling. You can then use the ObjectRecycleBin.cullExcessObjects method manually if
        /// you would still like to do any culling.
        /// </summary>
        public float cullExcessObjectsInterval = 10f;

        /// <summary>
        /// if true, DontDestroyOnLoad will be called on the ObjectPool
        /// </summary>
        ...
        /// </summary>
        Dictionary<int,ObjectRecycleBin> _instanceIdToRecycleBin = new Dictionary<int,ObjectRecycleBin>();
        ...
        /// <summary>
        /// tells ObjectPool to start managing the recycle bin at runtime
        /// </summary>
        /// <param name="recycleBin">Recycle bin.</param>
        public static void manageRecycleBin( ObjectRecycleBin recycleBin )
        {
        ...
        public static void removeRecycleBin( ObjectRecycleBin recycleBin, bool shouldDestroyAllManagedObjects = true )
        {
        ...
        /// </summary>
        public static ObjectRecycleBin recycleBinForGameObjectName( string gameObjectName )
        {
        ...
        /// <param name="go">Go.</param>
        public static ObjectRecycleBin recycleBinForGameObject( GameObject go )
        {
            ObjectRecycleBin recycleBin;
