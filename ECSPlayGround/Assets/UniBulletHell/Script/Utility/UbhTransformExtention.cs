...
public static class UbhTransformExtention
{
    ...
    {
        m_tmpVector3.Set(x, y, z);
        self.localEulerAngles = m_tmpVector3;
    }

    public static void SetLocalEulerAnglesX(this Transform self, float x)
    {
        self.SetLocalEulerAngles(x, self.localEulerAngles.y, self.localEulerAngles.z);
    }

    public static void SetLocalEulerAnglesY(this Transform self, float y)
    {
        self.SetLocalEulerAngles(self.localEulerAngles.x, y, self.localEulerAngles.z);
    }

    public static void SetLocalEulerAnglesZ(this Transform self, float z)
    {
        self.SetLocalEulerAngles(self.localEulerAngles.x, self.localEulerAngles.y, z);
    }
    ...
    {
        self.SetEulerAngles(self.eulerAngles.x + x, self.eulerAngles.y + y, self.eulerAngles.z + z);
    }

    public static void AddEulerAnglesX(this Transform self, float x)
    {
        self.SetEulerAnglesX(self.eulerAngles.x + x);
    }

    public static void AddEulerAnglesY(this Transform self, float y)
    {
        self.SetEulerAnglesY(self.eulerAngles.y + y);
    }

    public static void AddEulerAnglesZ(this Transform self, float z)
    {
        self.SetEulerAnglesZ(self.eulerAngles.z + z);
    }
    ...
    {
        self.SetLocalEulerAngles(self.localEulerAngles.x + x, self.localEulerAngles.y + y, self.localEulerAngles.z + z);
    }

    public static void AddLocalEulerAnglesX(this Transform self, float x)
    {
        self.SetLocalEulerAnglesX(self.localEulerAngles.x + x);
    }

    public static void AddLocalEulerAnglesY(this Transform self, float y)
    {
        self.SetLocalEulerAnglesY(self.localEulerAngles.y + y);
    }

    public static void AddLocalEulerAnglesZ(this Transform self, float z)
    {
        self.SetLocalEulerAnglesZ(self.localEulerAngles.z + z);
    }
