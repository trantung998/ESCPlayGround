...
{	
	...
	/// </summary>
	public class SkyTheoryGUIManager : GUIManager
	{
		[Header("Game Items")]
	    ...
	    {
	    	base.OnEnable();
	    	MMEventManager.StartListening("HighScoreReset",HighScoreReset);
	    }
		protected override void OnDisable()
		{
			base.OnDisable();
	    	MMEventManager.StopListening("HighScoreReset",HighScoreReset);	    	
	    }
