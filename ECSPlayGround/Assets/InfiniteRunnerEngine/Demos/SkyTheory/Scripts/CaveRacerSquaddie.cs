...
{	
	public class CaveRacerSquaddie : MonoBehaviour 
	{
		...
		{
			MMEventManager.StartListening("PlayableCharactersInstantiated",Initialize);
			MMEventManager.StartListening("GameStart",GameStart);
		}

		protected virtual void OnDisable()
		{
			MMEventManager.StopListening("PlayableCharactersInstantiated",Initialize);
			MMEventManager.StopListening("GameStart",GameStart);
		}
	}
}
