...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class Dragon : Flappy
	{
	    ...
	    protected override void Start()
	    {
			...
			StartCoroutine(MMImage.Flicker(LevelManager.Instance.CurrentPlayableCharacters[0].GetComponent<Renderer>(), flickerColor, 0.1f, StartImmunityDuration));
			DisableCollisions();
	    ...
	    protected override void UpdateAllMecanimAnimators()
	    {
			...
			MMAnimator.UpdateAnimatorBool(_flameAnimator, "Jumping", _jumping);
	    }
	    ...
	    protected override void Update()
	    {
	        ...
	        if (_grounded)
	        {
				...
				MMAnimator.UpdateAnimatorBool(explosion.GetComponent<Animator>(), "Grounded", _grounded);
