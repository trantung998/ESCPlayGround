...
{	
	...
	{		
	    ...
	    public virtual void LevelStart()
	    {
	        ...
	        MMEventManager.TriggerEvent("GameStart");
	    }
	    ...
	    protected virtual void InstantiateCharacters()
	    {
	        ...
	        MMEventManager.TriggerEvent("PlayableCharactersInstantiated");
	    }
		...
		protected virtual void AllCharactersAreDead()
		{
	        ...
	        MMEventManager.TriggerEvent("LifeLost");
	        _started = DateTime.UtcNow;
	        ...
	        if (GameManager.Instance.CurrentLives<=0)
			{
				...
				MMEventManager.TriggerEvent("GameOver");
	        }
	    }
