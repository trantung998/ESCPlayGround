...
public partial class MetaContext {
    ...
    public MetaEntity SetTimeService(ITimerService newInstance) {
        if (hasTimeService) {
    ...
    public void ReplaceTimeService(ITimerService newInstance) {
...
public partial class MetaEntity {
    ...
    public void AddTimeService(ITimerService newInstance) {
