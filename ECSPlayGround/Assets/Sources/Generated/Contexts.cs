...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        input.AddEntityIndex(new Entitas.EntityIndex<InputEntity, string>(
            MoveInput,
            input.GetGroup(InputMatcher.MoveInput),
            (e, c) => ((MoveInputComponent)c).id));

        input.AddEntityIndex(new Entitas.EntityIndex<InputEntity, string>(
            PlayerId,
            input.GetGroup(InputMatcher.PlayerId),
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<InputEntity> GetEntitiesWithMoveInput(this InputContext context, string id) {
        return ((Entitas.EntityIndex<InputEntity, string>)context.GetEntityIndex(Contexts.MoveInput)).GetEntities(id);
    }

    public static System.Collections.Generic.HashSet<InputEntity> GetEntitiesWithPlayerId(this InputContext context, string value) {
        return ((Entitas.EntityIndex<InputEntity, string>)context.GetEntityIndex(Contexts.PlayerId)).GetEntities(value);
    }
